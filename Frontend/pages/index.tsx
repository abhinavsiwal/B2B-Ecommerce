...
const Home: NextPage = () => {
  ...
  const getAllProducts =async()=>{
    try {
      setLoading(true);
      const {data} = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/products/products`);
      console.log(data);
  ...
  return (
    <React.Fragment>
      <div>
        ...
        {loading?(
          <main style={{display:"flex",justifyContent:"center",alignItems:"center",width:"100vw",height:"80vh",zIndex:100}}>
            <Spinner />
          </main>
        ):(
          <React.Fragment>
          ...
          <section className="container pt-md-3 pb-5 mb-md-3">
            ...
            <div className="row pt-4 mx-n2">
              ...
              {products && products.map((product:any)=>{
                return(
                  <div className="col-lg-3 col-md-4 col-sm-6 px-2 mb-4" key={product._id} >
